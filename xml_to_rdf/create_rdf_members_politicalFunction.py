...
def create_rdf_potical_function():
    g_political_functios = rdflib.Graph()
    g_political_functios.bind("greek_lp", greek_lp)
    g_political_functios.bind("rdfs", rdfs)
    ...
    with open(f"./rdfs/rdf_politicalFunction.rdf", "w", encoding='utf8') as f:
        f.write(g_political_functios.serialize(format='xml'))
    file_speakers_from_xmls.close()
    file_csv.close()
    f.close()
...
# todo MAIN PART HERE---
# ! this only one time
input_file_1 = "./parl_members_activity_1989onwards_with_gender.csv"
output_file_1 = "./_parl_members_activity_1989onwards_with_gender.csv"
input_file_2 = "./extra_roles_manually_collected.csv"
output_file_2 = "./_extra_roles_manually_collected.csv"
input_file_3 = "./formatted_roles_gov_members_data.csv"
output_file_3 = "./_formatted_roles_gov_members_data.csv"
